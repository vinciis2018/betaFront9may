...
export const createScreenGame = (screenId, gameData) => async (dispatch, getState) => {
  ...
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/screen/${screenId}/createScreenGame`, gameData, {
      headers: {
...
export const getScreenGameDetails = (screenId) => async (dispatch, getState) => {
  ...
  try {
    const {data} = await Axios.get(`http://3.7.140.85:3333/api/game/screen/${screenId}/gameDetails`);
    dispatch({
...
export const removeScreenGame = (screenId) => async (dispatch, getState) => {
  ...
  const {userSignin: {userInfo}} = getState();
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/screen/${screenId}/removeScreenGame`, screenId, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const playScreenGames = (screenId, interaction) => async (dispatch, getState) => {
  ...
  const {userSignin: {userInfo}} = getState();
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/screen/${screenId}/playScreenGame/${interaction}`, {screenId, interaction}, {
      headers : {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const createAssetGame = (assetId, gameData) => async (dispatch, getState) => {
  ...
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/asset/${assetId}/createAssetGame`, gameData, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const getAssetGameDetails = (assetId) => async (dispatch, getState) => {
  ...
  try {
    const {data} = await Axios.get(`http://3.7.140.85:3333/api/game/asset/${assetId}/gameDetails`);
    dispatch({
...
export const removeAssetGame = (assetId) => async (dispatch, getState) => {
  ...
  const {userSignin: {userInfo}} = getState();
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/asset/${assetId}/removeAssetGame`, assetId, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const playAssetGames = (assetId, interaction) => async (dispatch, getState) => {
  ...
  const {userSignin: {userInfo}} = getState();
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/asset/${assetId}/playAssetGame/${interaction}`, {assetId, interaction}, {
      headers : {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const createAdvertGame = (videoId, gameData) => async (dispatch, getState) => {
  ...
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/video/${videoId}/createAdvertGame`, gameData, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const getAdvertGameDetails = (videoId) => async (dispatch) => {
  ...
  try {
    const {data} = await Axios.get(`http://3.7.140.85:3333/api/game/video/${videoId}/gameDetails`);
    dispatch({
...
export const removeAdvertGame = (videoId) => async (dispatch, getState) => {
  ...
  const {userSignin: {userInfo}} = getState();
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/video/${videoId}/removeAdvertGame`, videoId, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const playAdvertGames = (videoId, interaction) => async (dispatch, getState) => {
  ...
  const {userSignin: {userInfo}} = getState();
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/video/${videoId}/playAdvertGame/${interaction}`, {videoId, interaction}, {
      headers : {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const createChannelGame = (channelId, gameData) => async (dispatch, getState) => {
  ...
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/channel/${channelId}/createChannelGame`, gameData, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const getChannelGameDetails = (channelId) => async (dispatch, getState) => {
  ...
  try {
    const {data} = await Axios.get(`http://3.7.140.85:3333/api/game/channel/${channelId}/gameDetails`);
    dispatch({
...
export const removeChannelGame = (channelId) => async (dispatch, getState) => {
  ...
  const {userSignin: {userInfo}} = getState();
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/channel/${channelId}/removeChannelGame`, channelId, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const playChannelGames = (channelId, interaction) => async (dispatch, getState) => {
  ...
  const {userSignin: {userInfo}} = getState();
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/channel/${channelId}/playChannelGame/${interaction}`, {channelId, interaction}, {
      headers : {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const createFilmGame = (filmId, gameData) => async (dispatch, getState) => {
  ...
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/film/${filmId}/createFilmGame`, gameData, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const getFilmGameDetails = (filmId) => async (dispatch) => {
  ...
  try {
    const {data} = await Axios.get(`http://3.7.140.85:3333/api/game/film/${filmId}/gameDetails`);
    dispatch({
...
export const removeFilmGame = (filmId) => async (dispatch, getState) => {
  ...
  const {userSignin: {userInfo}} = getState();
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/film/${filmId}/removeFilmGame`, filmId, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const playFilmGames = (filmId, interaction) => async (dispatch, getState) => {
  ...
  const {userSignin: {userInfo}} = getState();
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/film/${filmId}/playFilmGame/${interaction}`, {filmId, interaction}, {
      headers : {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const createShopGame = (shopId, gameData) => async (dispatch, getState) => {
  ...
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/shop/${shopId}/createShopGame`, gameData, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const getShopGameDetails = (shopId) => async (dispatch, getState) => {
  ...
  try {
    const {data} = await Axios.get(`http://3.7.140.85:3333/api/game/shop/${shopId}/gameDetails`);
    dispatch({
...
export const removeShopGame = (shopId) => async (dispatch, getState) => {
  ...
  const {userSignin: {userInfo}} = getState();
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/shop/${shopId}/removeShopGame`, shopId, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const playShopGames = (shopId, interaction) => async (dispatch, getState) => {
  ...
  const {userSignin: {userInfo}} = getState();
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/shop/${shopId}/playShopGame/${interaction}`, {shopId, interaction}, {
      headers : {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const createItemGame = (itemId, gameData) => async (dispatch, getState) => {
  ...
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/item/${itemId}/createItemGame`, gameData, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const getItemGameDetails = (itemId) => async (dispatch) => {
  ...
  try {
    const {data} = await Axios.get(`http://3.7.140.85:3333/api/game/item/${itemId}/gameDetails`);
    dispatch({
...
export const removeItemGame = (itemId) => async (dispatch, getState) => {
  ...
  const {userSignin: {userInfo}} = getState();
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/item/${itemId}/removeItemGame`, itemId, {
      headers: {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
...
export const playItemGames = (itemId, interaction) => async (dispatch, getState) => {
  ...
  const {userSignin: {userInfo}} = getState();
  try {
    const {data} = await Axios.post(`http://3.7.140.85:3333/api/game/item/${itemId}/playItemGame/${interaction}`, {itemId, interaction}, {
      headers : {
        Authorization: `Bearer ${userInfo.token}`
      }
    });
